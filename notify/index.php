...
class NIndex {
	...
	function sendAndroidUnicast() {
		try {
			...
			$unicast->setPredefinedKeyValue("device_tokens",    "AsjZiHN1i1GmZ7qeO2wH4HRq4t1VNEYL-jDqxRyKyVGr"); 
...
$demo = new NIndex("526498d656240b87c1152bff", "srhkeydth02feeocufvwfakbeulhcgrr");
