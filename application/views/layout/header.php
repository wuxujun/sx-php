...
<body id="body">
		...
		<hgroup>
			<h1 class="site_title">
				<a href="<?php echo base_url();?>"><img class="logo"
					src="<?php echo base_url();?>assets/images/logo.png" style="border:0"/><span
	...
	<aside id="sidebar" class="column" >
		...
		<ul class="toggle">
			...
			<li class="icn_network"><?php echo anchor('/debug',  lang('v_debug'));?></li>
		</ul>
		<h3><?php echo lang('m_company') ?></h3>
		<ul class="toggle">
			<li class="icn_add_apps"><?php echo anchor('/company/company', lang('m_company_info'));?></li>
		...
		<footer>
			...
			<p>
				Verion:0.1 wuxj9531@gmail.com</a>
			</p>
		</footer>
