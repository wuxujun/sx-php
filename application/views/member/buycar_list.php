<section id="main" class="column" style="height:1100px">
	<article class="module width_full">
		<header>
			<h3 class="tabs_involved"><?php echo  lang('m_salecar_s')?></h3>
			<!--
		...
		<table class="tablesorter" cellspacing="0">
			<thead>
				<tr>
					<th width="5%"><?php echo  lang('v_man_info_id')?></th>
					<th width="10%"><?php echo  lang('v_man_buycar_name')?></th>
					<th width="10%"><?php echo  lang('v_man_buycar_phone')?></th>
					<th width="8%"><?php echo  lang('v_man_buycar_price')?></th>
					<th width="15%"><?php echo  lang('v_man_buycar_car_type')?></th>
					<th width="8%"><?php echo  lang('v_man_buycar_year')?></th>
...
function pageselectCallback(page_index, jq){
	...
	{ 
		msg = msg+"<tr><td>";
		msg = msg+infos[index+i].buy_id;
		msg = msg+"</td><td>";
		msg = msg + infos[i+index].name;
		msg = msg+"</td><td>";
		msg = msg + infos[i+index].phone;
		msg = msg + "</td><td>";
		msg = msg + infos[i+index].price;
		msg = msg + "</td><td>";
		msg = msg + infos[i+index].car_type;
		msg = msg + "</td><td>";
		msg = msg + infos[i+index].year;
		msg = msg + "</td><td>";
		msg = msg + infos[i+index].addtime;
		msg = msg +"</td><td>"
		msg = msg +"<a  href='<?php echo site_url();?>/member/member/buycardeal/";
		msg = msg +infos[i+index].sale_id;
		msg = msg +"'>处理</a>";
