<section id="main" class="column" style="height:1100px">
	<article class="module width_full">
		<header>
			<h3 class="tabs_involved"><?php echo  lang('m_member_l')?></h3>
			<!--
		...
		<table class="tablesorter" cellspacing="0">
			<thead>
				<tr>
					...
					<th><?php echo  lang('v_man_member_addtime_l')?></th>
...
function pageselectCallback(page_index, jq){
	...
	{ 
		...
		msg = msg + "</td><td>";
		msg = msg + infos[i+index].status;
		msg = msg + "</td><td>";
		msg = msg + infos[i+index].addtime;
		msg = msg +"</td><td>"
		msg = msg +"<a  href='<?php echo site_url();?>/member/member/queryinfo/";
