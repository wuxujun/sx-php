<section id="main" class="column" style="height:1100px">
	<article class="module width_full">
		<header>
			<h3 class="tabs_involved"><?php echo  lang('m_member_approval')?></h3>
			<!--
		...
		<table class="tablesorter" cellspacing="0">
			<thead>
				<tr>
					...
					<th width="15%"><?php echo  lang('v_man_member_login_l')?></th>
					<th width="15%"><?php echo  lang('v_man_member_phone_l')?></th>
					<th width="15%"><?php echo  lang('v_man_member_code_l')?></th>
					<th width="5%"><?php echo  lang('v_man_list_state')?></th>
...
function pageselectCallback(page_index, jq){
	...
	{ 
		...
		msg = msg +"</td><td>"
		msg = msg +"<a  href='<?php echo site_url();?>/member/member/approvalinfo/";
