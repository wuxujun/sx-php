		...
		<table class="tablesorter" cellspacing="0">
			<thead>
				<tr>
					...
					<th width="15%"><?php echo  lang('v_man_salecar_name')?></th>
					<th width="15%"><?php echo  lang('v_man_salecar_phone')?></th>
					<th width="15%"><?php echo  lang('v_man_salecar_car_type')?></th>
...
function pageselectCallback(page_index, jq){
	...
	{ 
		...
		msg = msg +"</td><td>"
		msg = msg +"<a  href='<?php echo site_url();?>/member/member/salecardeal/";
