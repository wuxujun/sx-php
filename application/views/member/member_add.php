...
<section id="main" class="column">
	...
	<article class="module width_full">
		<header>
			<h3><?php if(isset($id)){echo lang('v_man_editMember');}else{ echo lang('v_man_addMember');} ?></h3>
		</header>
		<div class="module_content">
			<fieldset style="width: 48%; float: left; margin-right: 3%;">
				<label><?php echo lang('v_man_member_mobile') ?></label><?php echo form_error('mobile'); ?>
		...
		<footer>
			<div class="submit_link">
				...
				<?php if(isset($id)) echo form_input($pid);?>
				<input type='submit' id='submit' class='alt_btn'
					name="store/store/saveInfo"
