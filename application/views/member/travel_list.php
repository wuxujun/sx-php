<section id="main" class="column" style="height:1100px">
	<article class="module width_full">
		<header>
			<h3 class="tabs_involved"><?php echo  lang('m_travel_s')?></h3>
			<!--
		...
		<table class="tablesorter" cellspacing="0">
			<thead>
				<tr>
					...
					<th width="15%"><?php echo  lang('v_man_travel_name')?></th>
					<th width="15%"><?php echo  lang('v_man_travel_phone')?></th>
					<th width="10%"><?php echo  lang('v_man_travel_num1')?></th>
...
function pageselectCallback(page_index, jq){
	...
	{ 
		msg = msg+"<tr><td>";
		msg = msg+infos[index+i].travel_id;
		msg = msg+"</td><td>";
		msg = msg + infos[i+index].travel_name;
		msg = msg+"</td><td>";
		msg = msg + infos[i+index].travel_phone;
		msg = msg + "</td><td>";
		msg = msg + infos[i+index].travel_num1;
		msg = msg + "</td><td>";
		msg = msg + infos[i+index].addtime;
		msg = msg +"</td><td>"
		msg = msg +"<a  href='<?php echo site_url();?>/member/member/traveldeal/";
		msg = msg +infos[i+index].travel_id;
		msg = msg +"'>处理</a>";
