	...
	function changeTops(code,id)
	{
		var data = {
			...
			jQuery
					.ajax({
						type : "post",
						url : "<?php echo site_url()?>/mall/mall/modifySaleTop",
						data : data,
						success : function(msg) {
							document.getElementById('msg').innerHTML = "<?php echo  lang('v_man_mall_sale_modifyTopT')?>";	
							document.getElementById('msg').style.display="block";
							document.getElementById('label_'+id).innerHTML = code;					 
						},
						error : function(XmlHttpRequest, textStatus, errorThrown) {
							alert("<?php echo  lang('t_error')?>");
						},
						beforeSend : function() {
							document.getElementById('msg').innerHTML = '<?php echo  lang('v_man_mall_sale_waitModifyT')?>';
							document.getElementById('msg').style.display="block";
						},
						complete : function() {
						}
